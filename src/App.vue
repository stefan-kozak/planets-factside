<template>
   <div v-cloak id="nav">
      ...
      <div class="nav-planets">
         ...
         <router-link to="/venus">{{ planets[1].name }}</router-link>
         <router-link to="/earth">{{ planets[2].name }}</router-link>
         <router-link to="/mars">{{ planets[3].name }}</router-link>
         <router-link to="/jupiter">{{ planets[4].name }}</router-link>
         <router-link to="/saturn">{{ planets[5].name }}</router-link>
         <router-link to="/uranus">{{ planets[6].name }}</router-link>
         <router-link to="/neptune">{{ planets[7].name }}</router-link>
      </div>
   </div>
   <router-view :planet="planets" />
</template>
...
#app {
   ...
   text-align: center;
   color: #fff;
   background: url('../src/assets/background-stars.svg');
